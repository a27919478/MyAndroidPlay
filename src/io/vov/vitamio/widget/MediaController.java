...
public class MediaController extends FrameLayout{
    ...
    private OnCirculationListener mCirculationListener;
    ...
    //长按快退
    private View.OnTouchListener mOutLongListener = new OnTouchListener(){
        @Override
        public boolean onTouch(View v, MotionEvent event){
            if(event.getAction() == MotionEvent.ACTION_DOWN){
                show(3600000);
                longOutClicked = true;
                mOutButton.setBackgroundResource(getResources().getIdentifier("mediacontroller_bg_pressed", "color", mContext.getPackageName()));
                Thread t = new Thread(){
                    @Override
                    public void run(){
                        while(longOutClicked){
                ...
                mOutButton.setBackgroundResource(getResources().getIdentifier("transparent", "color", mContext.getPackageName()));
                longOutClicked = false;
    ...
    //长按快进
    private View.OnTouchListener mOutForwardListener = new OnTouchListener(){
        @Override
        public boolean onTouch(View v, MotionEvent event){
            if(event.getAction() == MotionEvent.ACTION_DOWN){
                show(3600000);
                longForwardClicked = true;
                mForwardButton.setBackgroundResource(getResources().getIdentifier("mediacontroller_bg_pressed", "color", mContext.getPackageName()));
                Thread t = new Thread(){
                    @Override
                    public void run(){
                        while(longForwardClicked){
                ...
                mForwardButton.setBackgroundResource(getResources().getIdentifier("transparent", "color", mContext.getPackageName()));
                longForwardClicked = false;
            }else if(event.getAction() == MotionEvent.ACTION_CANCEL){
                mForwardButton.setBackgroundResource(getResources().getIdentifier("transparent", "color", mContext.getPackageName()));
                longForwardClicked = false;
            }
    ...
    private boolean longOutClicked;
    private boolean longForwardClicked;
    private CheckBox mCirculationButton;
    ...
    private void initControllerView(View v){
        ...
        mOutButton = (ImageButton) v.findViewById(getResources().getIdentifier("mediacontroller_play_out", "id", mContext.getPackageName()));
        if(mOutButton != null){
            mOutButton.requestFocus();
            mOutButton.setOnTouchListener(mOutLongListener);
        }
        mForwardButton = (ImageButton) v.findViewById(getResources().getIdentifier("mediacontroller_play_forward", "id", mContext.getPackageName()));
        if(mForwardButton != null){
            mForwardButton.requestFocus();
            mForwardButton.setOnTouchListener(mOutForwardListener);
        }
        ...
        mCirculationButton = (CheckBox) v.findViewById(getResources().getIdentifier("mediacontroller_play_circulation", "id", mContext.getPackageName()));
        iv_back = (ImageView) v.findViewById(getResources().getIdentifier("mediacontroller_ivback", "id", mContext.getPackageName()));
        ...
        mCirculationButton.setOnClickListener(new OnClickListener(){
            @Override
            public void onClick(View v){
                mCirculationListener.OnCirculation(mCirculationButton);
            }
        });
        if(mFileName != null)
    ...
    public void setOnCirculationListener(OnCirculationListener l){
        mCirculationListener = l;
    }
    ...
    public interface OnCirculationListener{
        public void OnCirculation(CheckBox circulationButton);
    }
